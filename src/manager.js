    ...
    <div class="card --background-white-400 --border-radius-600 --margin-top --margin-200 --padding --padding-500">
        <div class="--flex-row">
            ...
            <div class="--flex-fill --flex-vertical">
                ...
                <div class="list --margin-100">
                    <div class="list-item list-item--bulletpoint --background-black-400 --text-200">
                        <a class='link --color-secondary --color-state --color-text-500 --inline --text-bold' href='https://ipfs.io/ipfs/${data.ipfs.video}' target='_blank'>
                            Open Using IPFS Gateway
                        </a>
                    </div>
                    <div class="list-item list-item--bulletpoint --background-black-400 --text-200">
                        <a class='link --color-secondary --color-state --color-text-500 --inline --text-bold' href='https://cloudflare-ipfs.com/ipfs/${data.ipfs.video}' target='_blank'>
                            Open Using Cloudflare IPFS Gateway
                        </a>
                    </div>
                </div>
            ...
            <div class="--flex-fill --flex-vertical">
                ...
                <div class="list --margin-100">
                    <div class="list-item list-item--bulletpoint --background-black-400 --text-200">
                        <a class='link --color-secondary --color-state --color-text-500 --inline --text-bold' href='https://ipfs.io/ipfs/${data.ipfs.audio}' target='_blank'>
                            Open Using IPFS Gateway
                        </a>
                    </div>
                    <div class="list-item list-item--bulletpoint --background-black-400 --text-200">
                        <a class='link --color-secondary --color-state --color-text-500 --inline --text-bold' href='https://cloudflare-ipfs.com/ipfs/${data.ipfs.audio}' target='_blank'>
                            Open Using Cloudflare IPFS Gateway
                        </a>
                    </div>
                </div>
...
const init = async function() {
    ...
    /* assets = await video.read({
        where: [["$ownerId", "==", identity]]
    }); 
  assets = await audio.read({
    where: [["$ownerId", "==", identity]]
  });*/
